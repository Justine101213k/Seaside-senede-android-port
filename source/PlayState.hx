...
class PlayState extends MusicBeatState
{
	...
	override public function create()
	{
		...
		#if android
		watermark = new FlxText(25, 700, "PORTED BY COOL GAMER", 20);
		...
		mcontrols = new Mobilecontrols();
			...
			{
				case VIRTUALPAD_RIGHT | VIRTUALPAD_LEFT | VIRTUALPAD_CUSTOM | VIRTUAL_LEFT_RIGHT:
	...
	public function startCountdown():Void
	{
		...
		FlxTween.tween(watermark, {x: 0, alpha: 1}, 1.3, {ease:FlxEase.linear});
		#end
